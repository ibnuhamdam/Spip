<div class="row">
    <div class="card col-lg-8 mx-auto">
        <div class="card-body">
            <h4 class="card-title">Tambah Form 8</h4>
            <?= form_open(''); ?>
                        ...
                        <div class="input-group mt-2">
                            <div class="input-group-prepend">
                                <span class="input-group-text">
                                    <input type="radio" name="id_tahap_kegiatan" id="id_tahap_kegiatan" value="<?= $tahap_kegiatan->id_tahap_kegiatan; ?>" <?= set_radio('id_tahap_kegiatan', $tahap_kegiatan->id_tahap_kegiatan); ?>>
                                </span>
                            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="pernyataan_risiko" id="pernyataan_risiko" class="form-control" rows="3" placeholder="Pernyataan Risiko"><?= set_value('pernyataan_risiko'); ?></textarea>
                <?= form_error('pernyataan_risiko'); ?>
            </div>
            <div class="form-group">
                <label for="penyebab">Penyebab</label>
                <textarea name="penyebab" id="penyebab" class="form-control" rows="3" placeholder="Penyebab"><?= set_value('penyebab'); ?></textarea>
                <?= form_error('penyebab'); ?>
            </div>
            <div class="form-group">
                <label for="sumber">Sumber</label>
                <div class="custom-control custom-checkbox mr-sm-2">
                    <input type="checkbox" name="sumber[]" class="custom-control-input" id="internal" value="internal" <?= set_checkbox('sumber[]', 'internal'); ?>>
                    <label class="custom-control-label" for="internal">Internal</label>
                </div>
                <div class="custom-control custom-checkbox mr-sm-2">
                    <input type="checkbox" name="sumber[]" class="custom-control-input" id="eksternal" value="eksternal" <?= set_checkbox('sumber[]', 'eksternal'); ?>>
            ...
            <div class="form-group">
                ...
                <textarea name="dampak" id="dampak" class="form-control" rows="3" placeholder="Dampak"><?= set_value('dampak'); ?></textarea>
                <?= form_error('dampak'); ?>
            </div>
            <div class="form-group">
                <label for="pemilik_risiko">Pemilik Risiko</label>
                <input type="text" name="pemilik_risiko" id="pemilik_risiko" class="form-control" value="<?= set_value('pemilik_risiko'); ?>" placeholder="Pemilik Risiko">

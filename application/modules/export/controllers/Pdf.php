...
{
    private $id_form_8 = 'F82703200001';
    ...
    function __construct()
    {
        ...
        $this->load->model('form/detail_form_22_model', 'df22');
    ...
    public function form_11($id)
    {
        ...
        $this->load->view('export/form_11_pdf',$data);
    }
    ...
    public function form_14($id) 
    {
        ...
        if ($form_14) {
            $data = ['detail_data' => $this->df14->get_detail($form_14->id_form_8), 'no' => 1, 'is_done' => $form_14->is_done, 'id_form_8' => $form_14->id_form_8, 'id_form_14' => $id, 'form_17' => $this->f17->get_form_8($form_14->id_form_8), 'role' => $this->role];
            
            $this->load->view('template/head');
            $this->load->view('export/form_14_pdf', $data);
    ...
    public function form_17($id) 
    {
        ...
        if ($form_17) {
            $data = ['detail_data' => $this->df17->get_detail($form_17->id_form_8), 'no' => 1, 'is_done' => $form_17->is_done, 'id_form_8' => $form_17->id_form_8, 'id_form_17' => $id, 'form_22' => $this->f22->get_form_8($form_17->id_form_8), 'role' => $this->role];
            
            $this->load->view('template/head');
            $this->load->view('export/form_17_pdf',$data);
        } else {
            show_404();
        }
    }
    ...
    public function form_22($id)
    {
        ...
        if ($form_22) {
            ...
            $data = ['detail_data' => $detail_data, 'responden' => $datas->result_array() ? $this->sf11->get_responden($datas->row()->id_pernyataan) : ''];
            // var_dump($data['detail_data'][1]);
            $this->load->view('template/head');
            $this->load->view('export/form_22_pdf',$data);

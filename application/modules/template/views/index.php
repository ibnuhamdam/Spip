...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?= base_url('assets/matriz1/'); ?>assets/libs/flot/css/float-chart.css" rel="stylesheet">
    <!-- Custom CSS -->
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?= base_url('assets/matriz1/'); ?>assets/images/logo-icon.png" alt="homepage" class="light-logo" />
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="<?= base_url('assets/matriz1/'); ?>assets/images/logo-text.png" alt="homepage" class="light-logo" />
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?= base_url('assets/matriz1/'); ?>assets/images/users/1.jpg" alt="user" class="rounded-circle" width="31"></a>

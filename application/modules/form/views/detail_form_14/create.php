        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <div class="custom-control custom-checkbox mr-sm-2">
                    <input type="checkbox" name="dpk[]" class="custom-control-input" id="detektif" value="detektif" <?= set_checkbox('dpk[]', 'detektif'); ?>>
                    <label class="custom-control-label" for="detektif">Detektif</label>
                </div>
                <div class="custom-control custom-checkbox mr-sm-2">
                    <input type="checkbox" name="dpk[]" class="custom-control-input" id="preventif" value="preventif" <?= set_checkbox('dpk[]', 'preventif'); ?>>
                    <label class="custom-control-label" for="preventif">Preventif</label>
                </div>
                <div class="custom-control custom-checkbox mr-sm-2">
                    <input type="checkbox" name="dpk[]" class="custom-control-input" id="korektif" value="korektif" <?= set_checkbox('dpk[]', 'korektif'); ?>>

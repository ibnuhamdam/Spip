    ...
    <div class="card col-lg-6 mx-auto">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="perbaikan_pemantauan" id="perbaikan_pemantauan" class="form-control" placeholder="Perbaikan Pemantauan" value="<?= set_value('perbaikan_pemantauan'); ?>">

...
class Form_22_model extends CI_Model
{
    private $table = 'form_22';
    private $order = 'DESC';
    private $primary_key = 'id_form_22';
    public $id_form_22;
    public $id_form_8;
    public $is_done = 0;
    public $status = 0;
    ...
    {
        $this->id_form_22 = $this->get_id_form_22();
    ...
    {
        $this->db->update($this->table, ['is_done' => 1], [$this->primary_key => $id_form_22]);
    }

    // Generate id_form_22
    public function get_id_form_22()
    {
